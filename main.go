...
import (
	...
	"github.com/Vioneta/VionetaOS/pkg/cache"
	"github.com/Vioneta/VionetaOS/pkg/config"
	"github.com/Vioneta/VionetaOS/pkg/sqlite"
	"github.com/Vioneta/VionetaOS/pkg/utils/command"
	"github.com/Vioneta/VionetaOS/pkg/utils/file"
	"github.com/Vioneta/VionetaOS/route"
...
func main() {
	...
	logger.Info("VionetaOS main service is listening...", zap.Any("address", listener.Addr().String()))
