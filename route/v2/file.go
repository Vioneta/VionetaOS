...
func (s *VionetaOS) GetFileTest(ctx echo.Context) error {
...
func (c *VionetaOS) CheckUploadChunk(ctx echo.Context, params codegen.CheckUploadChunkParams) error {
...
func (c *VionetaOS) PostUploadFile(ctx echo.Context) error {
